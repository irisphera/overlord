...
- `setup.sh` : standalone non-interactive installer (shell/editor tools, Node 24, uv, AWS CLI, codegraph, prime-agent 272k, shared skills, Context7 MCP, websearch enablement)
